...
%% Plotting
% Function 1 Call
[t_vec, av_pos_inert, av_att, tar_pos_inert, tar_att, pos_av_aspen,...
    att_av_aspen, pos_tar_aspen, att_tar_aspen] = LoadASPENData("3801_Sec001_Test1.csv");

%% Q3
% Grabbing data and plotting figures
